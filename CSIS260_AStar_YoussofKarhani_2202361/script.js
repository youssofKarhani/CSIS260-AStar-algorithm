...
function getEndPos(canvas, e) {
  ...
  if ( arrayOfNodes[nodeCol][nodeRow].isWall == 0 && (nodeCol != startNodeCol || nodeRow != startNodeRow) ) {
...
function findAStar() {
  ...
  do{
    if(!(parentOfParent.getXindex() == startNodeCol && parentOfParent.getYindex() == startNodeRow))
      drawYellow(parentOfParent.getXindex(), parentOfParent.getYindex());

    parentOfParent = parentOfParent.getParent();
  }while(!(parentOfParent.getXindex() == startNodeCol && parentOfParent.getYindex() == startNodeRow));
}
...
function getNeighbors(parentNodeCol, parentNodeRow) {
  ...
  //==================================================================================
  var leftCol = parentNodeCol - 1;      var leftRow = parentNodeRow; //left

  var upLeftCol = parentNodeCol - 1;    var upLeftRow = parentNodeRow - 1; //up left

  var upCol = parentNodeCol;            var upRow = parentNodeRow - 1; //up

  var upRightCol = parentNodeCol + 1;   var upRightRow = parentNodeRow - 1; //up right

  var rightCol = parentNodeCol + 1;     var rightRow = parentNodeRow; //right

  var downRightCol = parentNodeCol + 1; var downRightRow = parentNodeRow + 1; //down right

  var downCol = parentNodeCol;          var downRow = parentNodeRow + 1; //down

  var downLeftCol = parentNodeCol - 1;  var downLeftRow = parentNodeRow + 1; //down left
  //==================================================================================
  ...
  if (parentNodeCol != 0) {
    ...
    if(leftNode.getXindex() == endNode.getXindex() && leftNode.getYindex() == endNode.getYindex())
      return true;

    for (let i = 0; i < closedList.length; i++) {
      if (closedList[i] == leftNode)
       foundClosed = true;
    }
  ...
  if (parentNodeCol != 0 && parentNodeRow != 0) {
    ...
    if(upLeftNode.getXindex() == endNode.getXindex() && upLeftNode.getYindex() == endNode.getYindex())
      return true;
  ...
  if (parentNodeRow != 0) {
    ...
    if(upNode.getXindex() == endNode.getXindex() && upNode.getYindex() == endNode.getYindex())
      return true;
  ...
  if (parentNodeRow != 0 && parentNodeCol != counterGridWidth - 1) {
    ...
    if(upRightNode.getXindex() == endNode.getXindex() && upRightNode.getYindex() == endNode.getYindex())
      return true;
    ...
    if (foundClosed != true && upRightNode.getIsWall() != 1) {
      ...
      if (foundOpen == true) {
        ...
        //setting cost so far
        upRightNode.setCostSoFar(parentNode.getCostSoFar() + d);
  ...
  if (parentNodeCol != counterGridWidth - 1) {
    ...
    if(rightNode.getXindex() == endNode.getXindex() && rightNode.getYindex() == endNode.getYindex())
      return true;
  ...
  //down right
  //if parent 
  if (parentNodeCol != counterGridWidth-1 && parentNodeRow != counterGridHeight - 1) {
    var downRighNode = arrayOfNodes[downRightCol][downRightRow];
    if(downRighNode.getXindex() == endNode.getXindex() && downRighNode.getYindex() == endNode.getYindex())
      return true;
    ...
    if (foundClosed != true && downRighNode.getIsWall() != 1) {
      ...
      if (foundOpen == true) {
        ...
        downRighNode.setTotal(downRighNode.getCostSoFar() + downRighNode.getHeuristic());
      } else {
        //setting parent
  ...
  if (parentNodeRow != counterGridHeight -1) {
    ...
    if(downNode.getXindex() == endNode.getXindex() && downNode.getYindex() == endNode.getYindex())
    return true;
  ...
  if (parentNodeRow != counterGridWidth -1 && parentNodeCol != 0) {
    var downLeftNode = arrayOfNodes[downLeftCol][downLeftRow];
    if(downLeftNode.getXindex() == endNode.getXindex() && downLeftNode.getYindex() == endNode.getYindex())
    return true;

    for (let i = 0; i < closedList.length; i++) {
      if (closedList[i] == downLeftNode)
       foundClosed = true;
    }
    for (let i = 0; i < openList.length; i++) {
    ...
    if (foundClosed != true && downLeftNode.getIsWall() != 1) {
      ...
      if (foundOpen == true) {
        ...
        downLeftNode.setTotal(downLeftNode.getCostSoFar() + downLeftNode.getHeuristic());
      } else {
        //setting parent
